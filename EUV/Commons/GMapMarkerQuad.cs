...
namespace EUV.Commons
{
    ...
    {
        private readonly Bitmap icon = global::EUV.Properties.Resources.boat;
        ...
        static Color green = Color.FromArgb(0x8d, 0xc6, 0x3f);
        static Color blue = Color.FromArgb(0x00, 0xae, 0xef);
        ...
        public GMapMarkerQuad(PointLatLng p, float heading, float cog, float target, int sysid) : base(p)
        {
            {
                ...
                Size = icon.Size;
                // for hitzone
                Offset = new Point(-icon.Width / 4, -icon.Width / 4);
            }
        }
